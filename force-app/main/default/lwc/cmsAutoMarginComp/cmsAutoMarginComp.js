...
export default class CmsAutoMarginComp extends LightningElement {
    @api contentId;
    title;
    body;
    error;
    ...
    results({ data, error }) {
        if (data) {
            ...
            console.log('Original data.body.value:', data.body.value);
            console.log('Decoded HTML string:', htmlString); 
            ...
            allImages.forEach((img, index) => {
                ...
                console.log(`Image ${index + 1}: src="${oldSrc}", parent="${parentElement ? parentElement.tagName : 'none'}"`);
            ...
            // Add margin styling to heading and paragraph elements
            tempElement.querySelectorAll('h1, h2, h3, h4, h5, p').forEach(element => {
                element.style.margin = '0';
            });

            this.body = tempElement.innerHTML;
